...
public class TitleBarWithoutSearch extends FrameLayout {
    ...
    public TitleBarWithoutSearch(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initUI(context);
    }

    public TitleBarWithoutSearch(Context context, AttributeSet attrs) {
        super(context, attrs);
        initUI(context);
    }

    public TitleBarWithoutSearch(Context context) {
        super(context);
        initUI(context);
    }
    ...
    private void initUI(Context context) {
        LayoutInflater.from(context).inflate(R.layout.view_titlebar_without_search, this, true);
